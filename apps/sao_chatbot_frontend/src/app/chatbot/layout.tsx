...
export default function ChatLayout({
  ...
  return (
    <div className="flex h-screen w-full overflow-hidden bg-white text-[#1e293b]">
        ...
        <div className="flex-1 overflow-y-auto px-3 py-2 min-w-[280px]">
          ...
          <div className="space-y-1 pb-10">
            {history.map((item) => (
              ...
              >
                <Link
                  href={`/chatbot/${item.id}`} className="flex-1 truncate py-2 pl-4 pr-1" >
                ...
                <div className="relative shrink-0 pr-2">
                  ...
                  {activeMenuId === item.id && (
                    <div
                      ...
                      className="absolute right-0 top-1 z-[999] w-40 overflow-hidden rounded-lg border border-gray-200 bg-[#f8f9fa] shadow-xl"
      ...
      <main className="flex flex-1 flex-col relative h-full w-full min-w-0 bg-white gap-5">
