...
class InitialReviewAgents:
    ...
    def agent_criteria8_other_authority(self, text, criteria2_result=None):
        ...
        **3. กฎการตัดสินใจกรณีทับซ้อน (Overlap Rules):**
        - หากเป็นเรื่องที่มีความทับซ้อน ให้เน้นไปที่หน่วยงานที่มี **บทบาทหลัก** ตามพฤติการณ์ที่ปรากฏในเอกสาร
        - หากพฤติการณ์หลักคือการบริหารงบประมาณ/พัสดุผิดพลาด (แม้จะมีเรื่องวินัยปน) -> ให้ถือเป็น สตง. (ตอบ "ไม่เป็น")
        - หากพฤติการณ์หลักคือการรับสินบนหรือใช้อำนาจมิชอบเพื่อพวกพ้อง (แม้จะเกิดในโครงการจัดซื้อ) -> ให้ถือเป็น ป.ป.ช. (ตอบ "เป็น")
